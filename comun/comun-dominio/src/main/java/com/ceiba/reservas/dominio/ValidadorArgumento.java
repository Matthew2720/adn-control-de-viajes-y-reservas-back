package com.ceiba.reservas.dominio;
...
import com.ceiba.reservas.dominio.excepcion.ExcepcionLongitudValor;
...
public class ValidadorArgumento {
    ...
    public static void validarFechaNoMenorActual(LocalDateTime fecha, String mensaje) {
    ...
    public static void validarFechaNoMenor(LocalDateTime fecha, LocalDateTime fechaMinima, String mensaje) {
